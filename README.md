...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7312&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/github-ssh-auth-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `github-ssh-auth` can be installed with:

```
conda install github-ssh-auth
```

It is possible to list all of the versions of `github-ssh-auth` available on your platform with:
